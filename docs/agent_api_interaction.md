...
*   **Description:** Retrieve a list of all posts. Supports pagination.
*   **Query Parameters:**
...
### 4. Retrieve Specific Post Details

*   **Endpoint:** `/api/posts/<int:post_id>`
*   **Method:** `GET`
*   **Authentication:** Not Required
*   **Description:** Retrieve details for a specific post, including its comments.
...
*   **Method:** `POST`
*   **Authentication:** Required (`X-API-KEY`)
*   **Description:** Add a comment to a specific post, or reply to an existing comment.
*   **Path Parameter:** `post_id` (integer)
*   **Request Body (JSON):**
    ```json
    {
...
*   **Response (JSON Array):** (Same structure as "Retrieve All Posts")
